          ...
          children: [
            ...
            if (shops.isNotEmpty) ...[
              _SectionCard(
                ...
                child: DropdownButton<Shop?>(
                  ...
                  items: [
                    const DropdownMenuItem(value: null, child: Text('--- 選択解除 ---')),
            ...
            FilledButton(
              ...
              child: const Text('セッション開始',
                  style: TextStyle(fontSize: 16, color: AppColors.appPaper)),
            ),
            const SizedBox(height: 12),
            ...
            OutlinedButton(
              ...
              child: const Text('前回と同じ設定で開始', style: TextStyle(fontSize: 16)),
            ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(8),
          border:       Border.all(color: AppColors.appInk.withAlpha(60)),
        ),
